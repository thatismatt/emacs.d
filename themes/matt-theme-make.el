;; matt-theme-make.el -- matt's theme helpers
...
(defun matt-theme-make (theme-name &rest theme-colors)
  (let* ((*background*   (plist-get theme-colors :background))
         (theme-shade    (if (< 0.5 (color-luminance *background*)) :light :dark))
         (*background-1* (color-lighten-name *background* (if (eq :light theme-shade) -10 10)))
         (*background-2* (color-lighten-name *background* (if (eq :light theme-shade) -20 20)))
         (*background-3* (color-lighten-name *background* (if (eq :light theme-shade) -30 30)))
         (*default*      (plist-get theme-colors :default))
         (default-hsl    (apply 'color-rgb-to-hsl (color-name-to-rgb *default*)))
         (*default-1*    (color-darken-name *default* 10))
         (*default-2*    (color-darken-name *default* 20))
         (*default-3*    (color-darken-name *default* 30))
         (*default-4*    (color-darken-name *default* 40))
         (*default-5*    (color-darken-name *default* 50))
         ...
         (*success-bg-1* (color-darken-name *success* 12))
         (*success-bg-2* (color-darken-name *success* 22))
         (*warn*         (plist-get theme-colors :warn))
         (*error*        (plist-get theme-colors :error))
         (*error-1*      (color-darken-name *error* 10))
         (*error-bg-1*   (color-darken-name *error* 15))
         (*error-bg-2*   (color-darken-name *error* 25))
         (*a1*           (plist-get theme-colors :a1))
         (*a2*           (color-darken-name *a1* 10))
         (*a3*           (color-darken-name *a1* 25))
    ...
    (custom-theme-set-faces
     ...
     `(region ((t (:background ,*background-2* :foreground nil :distant-foreground nil))))
     `(secondary-selection ((t (:background ,*background-1* :foreground nil))))
     `(underline ((t (:underline t))))
     `(success ((t (:foreground ,*success*))))
     `(error ((t (:foreground ,*error*))))
     `(match ((t (:foreground ,*background* :background ,*a1*))))
     `(shadow ((t (:foreground ,*a2*))))
     ...
     ;; ediff
     `(ediff-even-diff-A ((t (:foreground ,*default-1* :background ,*background-2*))))
     `(ediff-odd-diff-A ((t (:foreground ,*default-2* :background ,*background-1*))))
     `(ediff-even-diff-B ((t (:foreground ,*default-1* :background ,*background-2*))))
     `(ediff-odd-diff-B ((t (:foreground ,*default-2* :background ,*background-1*))))

     ;; magit
     `(magit-diff-context ((t (:foreground ,*comment* :background nil))))
     `(magit-diff-removed ((t (:foreground ,*error-1* :background nil))))
     `(magit-diff-added ((t (:foreground ,*success-1* :background nil))))
     `(magit-diff-context-highlight ((t (:foreground ,*default* :background nil))))
     `(magit-diff-removed-highlight ((t (:foreground ,*error* :background nil))))
     `(magit-diff-added-highlight ((t (:foreground ,*success* :background nil))))
     `(magit-diff-file-heading-selection ((t (:foreground ,*b1*))))
     ;; (magit-diff-hunk-heading-selection ((t (:foreground ,*b1*))))
     ;; (magit-diff-hunk-heading-highlight ((t (:foreground ,*a1*))))
     ...
     `(magit-tag ((t (:foreground ,*d1* :background nil :box t))))
     ...
     ;; idle-highlight
     `(idle-highlight ((t (:background ,*background-1* :foreground nil))))
     ...
     `(org-todo ((t (:height 0.9 :foreground ,*error* :box t))))
     `(org-done ((t (:height 0.9 :foreground ,*success* :box t))))
     `(org-doing-face ((t (:height 0.9 :foreground ,*warn* :box t))))
     `(org-postponed-face ((t (:height 0.9 :foreground ,*comment* :box t))))
     `(org-query-face ((t (:height 0.9 :foreground ,*a1* :box t))))
     `(org-headline-done ((t (:foreground ,*comment*))))
     `(org-tag ((t (:height 0.9 :foreground ,*default-2*))))
     ...
     ;; calendar
     `(calendar-today ((t (:foreground ,*a1* :background nil :box t))))
     ...
     ;; helm
     `(helm-selection ((t (:background ,*background-2* :extend t))))
     `(helm-header ((t (:height 0.9 :foreground ,*b1*))))
     `(helm-source-header ((t (:height 1.2 :foreground ,*a1* :background nil))))
     `(helm-candidate-number ((t (:foreground ,*c1*))))
     `(helm-candidate-number-suspended ((t (:foreground ,*c2*))))
     `(helm-visible-mark ((t (:foreground ,*background* :background ,*d1*))))
     `(helm-buffer-size ((t (:foreground ,*comment*))))
     `(helm-buffer-process ((t (:foreground ,*d1*))))
     `(helm-buffer-directory ((t (:foreground ,*c1*))))
     `(helm-buffer-file ((t (:foreground ,*a1*))))
     `(helm-non-file-buffer ((t (:foreground ,*b1*))))
     `(helm-buffer-modified ((t (:foreground ,*a2* :slant italic))))
     `(helm-buffer-not-saved ((t (:foreground ,*error*))))
     `(helm-ff-prefix ((t (:foreground ,*background* :background ,*c1*))))
     `(helm-ff-directory ((t (:foreground ,*b1*))))
     `(helm-ff-directory-files ((t (:foreground ,*b1*))))
     `(helm-ff-executable ((t (:foreground ,*c1*))))
     `(helm-ff-dotted-directory ((t (:foreground ,*comment*))))
     `(helm-ff-symlink ((t (:foreground ,*d1*))))
     `(helm-ff-truename ((t (:foreground ,*e1*))))
     `(helm-grep-match ((t (:foreground ,*a1*))))
     `(helm-grep-lineno ((t (:foreground ,*c1*))))
     ...
     ;; company-echo
     ;; company-echo-common
     `(company-preview ((t (:foreground ,*background-1*))))
     `(company-preview-common ((t (:foreground ,*a1* :background ,*background-1*))))
     ;; company-preview-search
     `(company-scrollbar-bg ((t (:background ,*background-3*))))
     `(company-scrollbar-fg ((t (:background ,*background-2*))))
     ;; company-template-field
     `(company-tooltip ((t (:foreground ,*default* :background ,*background-1*))))
     `(company-tooltip-annotation ((t (:foreground ,*a1*))))
     ;; company-tooltip-annotation-selection
     `(company-tooltip-common ((t (:foreground ,*d1*))))
     ;; company-tooltip-common-selection
     ;; company-tooltip-mouse
     ;; company-tooltip-search
     ;; company-tooltip-search-selection
     `(company-tooltip-selection ((t (:background ,*background-2*))))
     ...
     ;; mortimer
     `(mortimer-mode-line-face ((t (:foreground ,*success*))))
     `(mortimer-mode-line-paused-face ((t (:foreground ,*error*))))
     `(mortimer-view-log-completed-face ((t (:foreground ,*success* :box t))))
     `(mortimer-view-log-unfinished-face ((t (:foreground ,*error* :box t))))
     )
